      ...
      <div className="w-[640px] rounded-lg py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button>
              <X
                onClick={openOrCloseConfirmTripModal}
        ...
        <form onSubmit={createTrip} className="space-y-3">
          ...
          <button className="bg-lime-300 text-lime-950 w-full justify-center rounded-lg px-5 h-11 font-medium flex items-center gap-2 hover:bg-lime-400">
